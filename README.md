...
Footer <img src="./images/footer" width="600" height="400">
...
### Existing Features
#### Navigation Bar
<img src="./images/03 Nav Bar" width="600" height="400">
...
<img src="./images/Home Page" width="600" height="400">

#### Team Section
The players section introduces the user to the different WFP teams in a fun and interesting manner.
A brief summary of what WFP do is included here so the user is armed with information and context from the start. 
<img src="./images/The Team" width="600" height="400">
...
<img src="./images/Forecasting" width="600" height="400">
